  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        {/* Page Header */}
        <div className="border-b border-border/50 bg-volt-surface/30">
          ...
          <div className="flex gap-8">
            ...
            <aside
              className={cn(
                ...
                "hidden lg:block",
                isFilterOpen && "fixed inset-0 z-50 bg-background p-6 lg:relative lg:inset-auto lg:z-auto lg:bg-transparent lg:p-0 block"
              )}
            >
              {isFilterOpen && (
              ...
              {hasActiveFilters && (
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedCategory && (
                      <Badge variant="category" className="cursor-pointer" onClick={() => updateFilter("category", "")}>
                        {categories.find((c) => c.slug === selectedCategory)?.name}
                        <X className="h-3 w-3 ml-1" />
                      </Badge>
                    )}
                    {selectedBrand && (
                      <Badge variant="category" className="cursor-pointer" onClick={() => updateFilter("brand", "")}>
                        {selectedBrand}
                        <X className="h-3 w-3 ml-1" />
                      </Badge>
                    )}
                ...
                <div className="space-y-2">
                  {categories.map((category) => (
                    <button
                      ...
                      onClick={() => updateFilter("category", selectedCategory === category.slug ? "" : category.slug)}
                    >
