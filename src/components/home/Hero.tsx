...
export function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="gradient-orb w-[500px] h-[500px] bg-aura-sky/20 bottom-0 -left-40" style={{ animationDelay: "-5s" }} />
      ...
      <div className="container relative z-10 mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8 animate-fade-in">
            ...
            <span className="text-sm font-medium text-primary">Aura Essentials 2024</span>
          </div>
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-bold leading-tight mb-6 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
            Calm, premium tech
            <br />
            <span className="gradient-text">for modern living</span>
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
            <div className="flex items-center justify-center gap-3 p-4 rounded-xl bg-aura-surface/70 border border-border/30">
